...
public class AWBlockEntityRenderers {
	...
	public static void initialize() {
		BlockEntityRenderers.register(AWBlockEntities.INVALID_CONVERSION, InvalidConversionBlockRenderer::new);
		...
		BlockEntityRenderers.register(AWBlockEntities.ADVANCED_SPAWNER, AdvancedSpawnerBlockEntityRenderer::new);
		BlockEntityRenderers.register(AWBlockEntities.FACTION_BANNER, FactionBannerRenderer::new);
	}
}
